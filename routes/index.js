...
res.render('index', { title: 'smartphone App', user : req.user });
});
router.get('/register', function(req, res) {
  res.render('register', { title: 'smartphone App Registration'});
  });
  ...
  res.render('login', { title: 'smartphone App Login', user : req.user });
  });
